...
make_group(group1_b,
	...
	sub_i2rm_b, inv, inv, cmp_i2rm_b)

/* 0x81 */
make_group(group1_v,
	add_i2rm_v, inv, adc_i2rm_v, sbb_i2rm_v, 
	sub_i2rm_v, inv, inv, cmp_i2rm_v)

/* 0x83 */
make_group(group1_sx_v,
	add_sib2rm_v, inv, adc_sib2rm_v, sbb_sib2rm_v, 
	sub_sib2rm_v, inv, inv, cmp_sib2rm_v)
...
/* 0xc0 */	group2_i_b, group2_i_v, inv, ret_rel_v,
